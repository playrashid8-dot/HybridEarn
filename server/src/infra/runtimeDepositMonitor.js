...
import { getPollingDepositEngineStatus } from "../hybrid/services/pollingDepositEngine.js";
  ...
  global.setInterval(async () => {
    ...
    const payload = {
      ...
      wsRuntime: typeof getWsRuntimeSnapshot === "function"
        ...
        : null,
      pollingRuntime: getPollingDepositEngineStatus(),
      realtimeHealthy:
        getPollingDepositEngineStatus().active ||
